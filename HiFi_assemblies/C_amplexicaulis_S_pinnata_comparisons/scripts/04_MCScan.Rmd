...
python -m jcvi.formats.gff bed --type=mRNA --key=Name ../genespace_genomes/S_diversifolius/HiFiasm_S.div.small.gff3.gz -o S_div.bed
...
```{r}
Sdiv_ids <- read_tsv("../../ACK_MCscan_plots/input/1Mb_HiFiasm_S.div.fasta.fai", col_names = "seqID", col_select = 1)
...
Sdiv_ids <- Sdiv_ids[c(1,   2,15,   3,  4,    6, 7,16, 8,
                       12,  14,    13, 18,5, 11,  17,  9),]
