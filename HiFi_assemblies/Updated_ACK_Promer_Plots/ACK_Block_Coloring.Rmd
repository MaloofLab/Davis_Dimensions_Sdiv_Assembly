...
```{r}
fplot <- read_delim("Promer_S.div_vs_TAIR10.fplot",
                  col_names = c("Reference", "Query", "pct.identity"),
                  comment = "#",
                  delim = " ")
rplot <- read_delim("Promer_S.div_vs_TAIR10.rplot",
                  col_names = c("Reference", "Query", "pct.identity"),
                  comment = "#",
                  delim = " ")
...
# paths <- file.path(paste0("Promer_S.div_vs_TAIR10_ACK_", 0:8, ".gplot"))
...
# Edit for plotting
```{bash}
<!-- for i in $(ls Promer_S.div_vs_TAIR10_ACK_*.gplot) -->
<!-- do -->
